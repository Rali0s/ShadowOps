...
const STUDY_TECHNIQUES: StudyTechnique[] = [
  {
    ...
    description:
      "Ancient mnemonic technique using spatial memory to store and retrieve information in familiar locations",
    steps: [
      "Choose a familiar location (pyramid, volcano, royal palance)",
      "Map key stations (rooms, halls, objects)",
      ...
      "Think of a ACE of Spade as a Sequence of Events or Item",
    ],
    benefits: [
  ...
  },
  {
    ...
    description:
      "Verbal explanation technique adapted from programming to force clarity and expose knowledge gaps",
    steps: [
      "Choose your 'duck' (object, skull, or mirror)",
      "Walk through your Mind Palace verbally",
      "Explain each station, concept, issue aloud",
  ...
  },
  {
    ...
    description:
      "Combined system integrating Mind Palace construction with Rubber Duck debugging for maximum retention",
    steps: [
...
const EXAMPLE_PALACE: PalaceStation[] = [
  ...
  {
    location: "Volcano Room",
    concept: "Cognitive Theory",
    visualization: "Giant Room in Volcano with Choice Colors or Black",
      ...
      <div className="max-w-7xl mx-auto container-responsive py-4 sm:py-6">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-terminal-red-secondary">
                Advanced memory techniques for psychological programming and
          ...
          <Alert className="border-terminal-red-primary bg-terminal-red-primary/10">
            ...
            <AlertTitle className="text-terminal-red-bright">
              Mentalist Training Guide
            </AlertTitle>
            <AlertDescription className="text-terminal-red-secondary">
              Mind Palace + Rubber Duck Debugging for Memory & Mentalism. Think
              for yourself. Question everything. DYOR.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <Tabs defaultValue="techniques" className="space-y-4 sm:space-y-6">
          <TabsList className="grid grid-cols-2 sm:grid-cols-4 w-full bg-terminal-red-dark">
            <TabsTrigger
              value="techniques"
              className="text-terminal-red-secondary data-[state=active]:text-white text-xs sm:text-sm"
            >
              <span className="hidden sm:inline">Study Techniques</span>
              <span className="sm:hidden">Techniques</span>
            </TabsTrigger>
            <TabsTrigger
              value="palace-example"
              className="text-terminal-red-secondary data-[state=active]:text-white text-xs sm:text-sm"
            >
          ...
          <TabsContent value="techniques" className="space-y-6">
            <div className="grid gap-6">
              {STUDY_TECHNIQUES.map((technique, index) => (
                <Card
                  key={index}
                  className="bg-card-bg border-terminal-red-muted"
                >
                  <CardHeader>
                    <CardTitle className="text-terminal-red-bright flex items-center gap-3">
                      ...
                      {technique.title}
                      <Badge
                        className={DIFFICULTY_COLORS[technique.difficulty]}
                      >
                    ...
                    <div>
                      ...
                      <ol className="space-y-2">
                        {technique.steps.map((step, stepIndex) => (
                          <li
                            key={stepIndex}
                            className="flex items-start gap-3 text-terminal-red-secondary"
                          >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        {technique.benefits.map((benefit, benefitIndex) => (
                          <div
                            key={benefitIndex}
                            className="flex items-center gap-2 text-terminal-red-secondary text-sm"
                          >
          ...
          <TabsContent value="palace-example" className="space-y-6">
            <Card className="bg-card-bg border-terminal-red-muted">
              <CardHeader>
                ...
                <CardDescription className="text-terminal-red-secondary">
                  Interactive walkthrough of a Mind Palace built to memorize a
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4">
                      {EXAMPLE_PALACE.map((station, index) => (
                        <div
                          key={index}
                          className="p-4 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted"
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <Badge
                                variant="outline"
                                className="border-terminal-red-muted text-terminal-red-secondary mb-2"
                              >
                                {station.concept}
                              </Badge>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold text-terminal-red-bright">
                        Palace Walkthrough - Station {currentStation + 1} of{" "}
                        {EXAMPLE_PALACE.length}
                      </h3>
                      <Button
                          ...
                          <div className="space-y-3 text-left max-w-2xl mx-auto">
                            <div className="p-4 bg-terminal-red-dark/50 rounded-lg">
                              <p className="text-terminal-red-secondary">
                                <strong className="text-terminal-red-bright">
                                  Visualization:
                                </strong>
                                <br />
            ...
            <div className="grid gap-6">
              <Card className="bg-card-bg border-terminal-red-muted">
                <CardHeader>
                  ...
                  <CardDescription className="text-terminal-red-secondary">
                    Adapt programming debugging techniques to strengthen memory
                    palaces and expose knowledge gaps
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h3 className="font-semibold text-terminal-red-bright mb-3">
                        Choose Your Duck or Shakespeare Skull
                      </h3>
                      <div className="space-y-3">
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                            Physical Object
                          </div>
                          <p className="text-sm text-terminal-red-secondary">
                            Rubber duck, Shakespeare Skull, or any object on
                            your desk
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          ...
                          <p className="text-sm text-terminal-red-secondary">
                            Explain to yourself in a mirror for self-reflection
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                          ...
                          <p className="text-sm text-terminal-red-secondary">
                            Symbolic character living within your Mind Palace
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          <div className="w-6 h-6 bg-terminal-red-primary rounded-full flex items-center justify-center text-white text-sm font-bold mt-0.5">
                            1
                          </div>
                          <p className="text-terminal-red-secondary text-sm">
                            Walk through palace verbally narrating each station
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-6 h-6 bg-terminal-red-primary rounded-full flex items-center justify-center text-white text-sm font-bold mt-0.5">
                          ...
                          <p className="text-terminal-red-secondary text-sm">
                            Identify stations where explanation falters or feels
                            unclear
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-terminal-red-secondary text-sm">
                            Strengthen weak images with more vivid, absurd
                            visualizations
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="p-4 bg-terminal-red-dark/20 rounded-lg text-center">
                        ...
                        <h4 className="font-medium text-terminal-red-bright mb-1">
                          Verbal Rehearsal
                        </h4>
                        <p className="text-sm text-terminal-red-secondary">
                          Activates auditory memory pathways alongside visual
                        </p>
                      </div>
                      <div className="p-4 bg-terminal-red-dark/20 rounded-lg text-center">
                        ...
                        <p className="text-sm text-terminal-red-secondary">
                          Forces confrontation with weak associations
                        </p>
                      </div>
                      <div className="p-4 bg-terminal-red-dark/20 rounded-lg text-center">
                        ...
                        <p className="text-sm text-terminal-red-secondary">
                          Self-correcting system strengthens over time
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid gap-6">
              <Card className="bg-card-bg border-terminal-red-muted">
                <CardHeader>
                  ...
                  <CardDescription className="text-terminal-red-secondary">
                    Master-level strategies for memory palace construction and
                    cognitive enhancement
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                            Logic Duck || Logic Skull
                          </div>
                          <p className="text-sm text-terminal-red-secondary">
                            For analytical reasoning and fact checking
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                            Creative Duck || Creative Skull
                          </div>
                          <p className="text-sm text-terminal-red-secondary">
                            For generating vivid imagery and associations
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                            Skeptic Duck || Skeptic Skull
                          </div>
                          <p className="text-sm text-terminal-red-secondary">
                            For challenging assumptions and bias detection
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          ...
                          <p className="text-sm text-terminal-red-secondary">
                            Each station holds arguments for AND against topics
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                            Martial Arts Palace - See KSP Memorization
                          </div>
                          <p className="text-sm text-terminal-red-secondary">
                            Each station represents moves in kata/flow sequences
                          </p>
                        </div>
                        <div className="p-3 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                          <div className="font-medium text-terminal-red-bright mb-1">
                          ...
                          <p className="text-sm text-terminal-red-secondary">
                            Dedicated to research notes with balanced thinking
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    <h3 className="font-semibold text-terminal-red-bright mb-4">
                    ...
                    <div className="grid gap-4">
                      <div className="p-4 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                        ...
                        <p className="text-sm text-terminal-red-secondary mb-2">
                          Create audio walkthroughs of your palace to reinforce
                          pathways through multiple listening sessions.
                        </p>
                      ...
                      <div className="p-4 bg-terminal-red-dark/20 rounded-lg border border-terminal-red-muted">
                        ...
                        <p className="text-sm text-terminal-red-secondary mb-2">
                          Use background frequencies (Alpha 8-12 Hz for
                          learning, Theta 4-8 Hz for deep encoding) during
                          palace construction.
                        </p>
