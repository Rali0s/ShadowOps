    ...
    <div className={`countdown-timer ${className}`}>
      <div className="bg-gradient-to-r from-red-900/20 to-black border border-red-500/50 rounded-lg p-3 sm:p-6">
        <div className="flex items-center justify-center mb-3 sm:mb-4">
          ...
          <h3 className="text-sm sm:text-base md:text-lg font-bold text-red-400">
        ...
        <div className="text-center mb-2">
          ...
          <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-mono font-bold text-white leading-tight">
